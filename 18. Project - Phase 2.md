...
| Student | Staff |
|---------|-------|
| - Mã số sinh viên <br />  - Tên  - Giới tính  - Ngày, tháng, năm sinh  - Email  - Số điện thoại  - Địa chỉ  - Điểm trung bình | - Mã số nhân viên  - Tên  - Giới tính  - Ngày, tháng, năm sinh  - Email  - Số điện thoại  - Số điện thoại công việc  - Địa chỉ  - Lương |
