...
Thành phần sau từ khóa `new` chính là constructor của class mà chúng ta khỏi tạo **instance**, như ở ví dụ trên `Scanner(System.in)` chính là Parameterized Constructor của lớp **Scanner**.
