...
Có nghĩa là khi trong quan hệ kế thừa, nếu class con không có method cần gọi thì chương trình sẽ tìm lên và gọi method trong class cha. Nếu class cũng không có method cần gọi thì mới báo lỗi compile.
